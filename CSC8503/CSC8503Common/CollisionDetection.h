...
namespace NCL {
	...
	public:
		...
		static bool CapsuleOBBIntersection(const CapsuleVolume& volumeA, const Transform& worldTransform,
			const OBBVolume& volumeB, const Transform& worldTransformB, CollisionInfo& collisionInfo);

		static bool CapsuleAABBIntersection(const CapsuleVolume& volumeA, const Transform& worldTransform,
			const AABBVolume& volumeB, const Transform& worldTransformB, CollisionInfo& collisionInfo);
